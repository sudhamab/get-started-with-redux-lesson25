...
class Provider extends Component {
  /*
  ** this childContext method makes the store available to all 
  ** children and grand children components.
  ** So I think when React calls a child component, internally
  ** it probably tries to call the getChildContext as well 
  ** to establish the child context and in this case, it would
  ** also assign the store to become part of the context. 
  */
  getChildContext() {
    return {
...
/*
** If you don't specify the childContextTypes, 
** no child will get the context
*/
